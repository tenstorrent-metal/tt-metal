...
void kernel_main() {
    ...
    //cb_push_back(cb_id_in1, batch * num_blocks * in1_block_h * in1_block_w);
    #else
    ...
    *(in1_mcast_receiver_semaphore_addr_ptr) = VALID;
    ...
    constexpr uint32_t in1_block_size_bytes = in1_block_h * in1_block_w * in1_single_tile_size_bytes;
