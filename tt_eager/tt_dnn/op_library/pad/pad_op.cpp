...
void Pad::validate(const std::vector<Tensor> &input_tensors) const {
    ...
    if (input_tensor.layout() == Layout::TILE) {
        ...
        TT_FATAL(input_tensor.dtype() == DataType::FLOAT32 || input_tensor.dtype() == DataType::BFLOAT16, "Cannot pad tilized tensor with specified format");
        ...
        TT_FATAL(input_tensor.dtype() == DataType::FLOAT32 || input_tensor.dtype() == DataType::BFLOAT16, "Cannot pad RM tensor with specified format");
    }
