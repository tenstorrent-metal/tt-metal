...
void py_module(py::module& m_transformers) {
    ...
    py::class_<SoftmaxShardedDefaultProgramConfig>(m_transformers, "SoftmaxShardedDefaultProgramConfig")
        .def(py::init<>());
    ...
    m_transformers.def(
        ...
        py::arg("program_config").noconvert() = SoftmaxShardedDefaultProgramConfig{},
