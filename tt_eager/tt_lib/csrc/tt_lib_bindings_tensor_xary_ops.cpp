...
namespace tt::tt_metal::detail {
    void TensorModuleXaryOPs( py::module & m_tensor){
        ...
        m_tensor.def("add_without_autoformat", &add_without_autoformat,
            py::arg("input_a").noconvert(), py::arg("input_b").noconvert(), py::arg("fused_activations") = std::nullopt, py::arg("output_mem_config").noconvert() = operation::DEFAULT_OUTPUT_MEMORY_CONFIG, py::arg("output_dtypee").noconvert() = std::nullopt, py::arg("in_place") = false,
