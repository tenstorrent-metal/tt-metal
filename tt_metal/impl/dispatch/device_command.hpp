...
class DeviceCommand {
   public:
    ...
    static constexpr uint32_t relay_cb_size_idx = 19;
    static constexpr uint32_t relay_cb_num_pages_idx = 20;
    static constexpr uint32_t producer_relay_transfer_num_pages_idx = 21;
    static constexpr uint32_t consumer_relay_transfer_num_pages_idx = 22;
    ...
    void set_producer_relay_transfer_num_pages(const uint32_t producer_relay_transfer_num_pages);

    void set_consumer_relay_transfer_num_pages(const uint32_t consumer_relay_transfer_num_pages);
