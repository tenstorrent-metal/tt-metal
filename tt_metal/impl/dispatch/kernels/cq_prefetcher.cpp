...
void kernel_main() {
    ...
    while (true) {
        ...
        if constexpr (pull_and_push_config == tt::PullAndPushConfig::LOCAL) {
            ...
            relay_command<command_start_addr, eth_l1_mem::address_map::ERISC_APP_RESERVED_BASE, consumer_data_buffer_size>(false, push_noc_encoding); // SRC router has one cmd slot
            ...
            volatile db_cb_config_t* remote_multicore_cb_cfg = get_remote_db_cb_config(eth_l1_mem::address_map::CQ_CONSUMER_CB_BASE);
