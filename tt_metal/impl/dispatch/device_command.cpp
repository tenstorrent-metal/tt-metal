...
void DeviceCommand::set_relay_cb_size(const uint32_t cb_size) { this->desc[this->relay_cb_size_idx] = cb_size; }
...
void DeviceCommand::set_relay_cb_num_pages(const uint32_t cb_num_pages) { this->desc[this->relay_cb_num_pages_idx] = cb_num_pages; }
...
void DeviceCommand::set_producer_relay_transfer_num_pages(const uint32_t producer_relay_transfer_num_pages) {
    this->desc[this->producer_relay_transfer_num_pages_idx] = producer_relay_transfer_num_pages;
}

void DeviceCommand::set_consumer_relay_transfer_num_pages(const uint32_t consumer_relay_transfer_num_pages) {
    this->desc[this->consumer_relay_transfer_num_pages_idx] = consumer_relay_transfer_num_pages;
}
