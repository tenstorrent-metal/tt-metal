...
from models.experimental.falcon7b.reference.hf_modeling_falcon import (
    FalconForCausalLM,
)

# import prefill MLP
from models.experimental.falcon7b.tt.prefill.falcon_mlp import TtFalconMLP as TtFalconMLPPrefill
from models.experimental.falcon7b.tt.decode.falcon_mlp import TtFalconMLP as TtFalconMLPDecode
from models.experimental.falcon7b.tt.prefill.model_config import (
    get_model_config,
    get_tt_cache_path,
)
...
def run_test_FalconMLP_inference(
    ...
    TtFalconMLP = TtFalconMLPPrefill if llm_mode == "prefill" else TtFalconMLPDecode
...
@pytest.mark.parametrize(
    "model_version, batch, llm_mode, seq_len, pcc",
    (
        (
