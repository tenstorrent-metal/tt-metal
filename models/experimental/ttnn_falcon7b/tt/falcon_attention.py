...
class TtFalconAttention(nn.Module):
    ...
    def forward(
        ...
        # hidden_states = ttnn.Tensor(hidden_states)
        # query_key_value_weights = ttnn.Tensor(self.query_key_value_weights)

        # # TODO(jchu): run exactly as tt_lib.tensor.falcon_fused_qkv_matmul
        ...
        # fused_query_key_value = fused_query_key_value.value
