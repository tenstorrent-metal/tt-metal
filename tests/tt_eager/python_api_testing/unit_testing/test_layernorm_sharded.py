...
#     ],
# )
# def test_layernorm_sharded(test_id, in_dtype, out_dtype, cb_dtype, in0_mem_config, gamma_beta_mem_config, out_mem_config, device):
#     torch.manual_seed(1234)
...
#     (0, 1, 2),
#     ids=[
#         "add_LN", "add_LN_G", "add_LN_GB",
#     ],
# )
# def test_layernorm_sharded_mix_precision(test_id, in_dtype, out_dtype, cb_dtype, in0_mem_config, gamma_beta_mem_config, out_mem_config, device):
#     torch.manual_seed(1234)
