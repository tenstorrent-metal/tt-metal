...
int main(int argc, char **argv) {
    ...
    try {
        ...
        TT_FATAL(num_tensor_tiles%Wt == 0);
        ...
        TT_FATAL(result_vec.size() == NC*H*TILE_WIDTH/2); // we are expecting one tile in H, and half the elements since the vector packs 2 uint16_ts
